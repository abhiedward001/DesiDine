    ...
    <>
            <div className='relative my-16'>
                ...
                <div className='Image h-[500px]  w-10/12 mx-auto '>
                    <img className='h-[500px] w-full rounded-b-[350px] rounded-t-[20px] ' src="https://cdn.jsdelivr.net/gh/abhiedward001/AssetDesiDine/headerShow.jpg" alt='Not displaying'></img>
                </div>
