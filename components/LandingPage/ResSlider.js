...
function ResSlider() {
  return (
    ...
    <div>
    <img className='w-full h-[600px] opacity-95' src="https://github.com/abhiedward001/AssetDesiDine/blob/main/slide.jpg" alt=''></img>
        <Carousel.Caption>
    ...
    <Carousel.Item className='w-full h-[600px]'>
        <div>
        <img className='w-full h-[600px] opacity-95' src="https://github.com/abhiedward001/AssetDesiDine/blob/main/slide2.jpg" alt=''></img>
        <Carousel.Caption>
    ...
    <Carousel.Item className='w-full h-[600px]'>
    <div >
    <img className='w-full h-[600px] opacity-95' src="https://github.com/abhiedward001/AssetDesiDine/blob/main/slide3.webp" alt=''></img>
        <Carousel.Caption>
