...
function ResSlider() {
  return (
    ...
    <div>
    <img className='w-full h-[600px] opacity-95' src={slide1} alt=''></img>
        <Carousel.Caption>
    ...
    <Carousel.Item className='w-full h-[600px]'>
        <div>
        <img className='w-full h-[600px] opacity-95' src={slide2} alt=''></img>
        <Carousel.Caption>
    ...
    <Carousel.Item className='w-full h-[600px]'>
    <div >
    <img className='w-full h-[600px] opacity-95' src={slide3} alt=''></img>
        <Carousel.Caption>
